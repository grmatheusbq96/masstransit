...
namespace RabbitMq.Studies.Api.Controllers
{
    ...
    [ApiController]
    public class DecoratorDemoController/*(IServicoUm servicoUm)*/ : ControllerBase
    ...
    {
        //private readonly IServicoUm _servicoUm = servicoUm;

        //[HttpGet]
        //public IActionResult Get()
        //{
        //    //_servicoUm.RealizarTarefaQueEstaDentroDeServicoDois();

        //    var servicoUm = new ServicoUm(new ServicoDois());
        //    servicoUm.RealizarTarefaQueEstaDentroDeServicoDois();
